...
export const NewsCard = ({ id, description, link, title }: NewsCardProps) => {
  return (
    <Link
      ...
      to={`/news/${id}`}
    >
      <h3 className="text-[17px] font-semibold text-[var(--color-gray-700)] group-hover:text-[var(--color-red-200)] transition-colors duration-200 line-clamp-2">
        {title}
      </h3>
